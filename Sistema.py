            ...
            while s == True:
                if usuario_actual is not None:
                    if es_admin:
                        ...
                        print('4. ver stcok')
                        print('5. ver ventas')
                        print("6. ver top usuarios invitados")
                        ...
                        match opcion:
                            ...
                            case "6":
                                # Estamos viendo que el grafico queda invertido y ademas no se visualiza la primer barra
                                lista_invitados=[]
                                matriz_invitados=[]
                                acceso = []
                                dni = []
                                ...
                                with open ("invitado.txt","r") as archivo:
                                    ...
                                    for linea in archivo:
                                        lista_invitados= linea.strip().split(",")
                                        matriz_invitados.append(lista_invitados)
                                archivo.close()
                                for i in range(len(matriz_invitados)):
                                    acceso.append(int(matriz_invitados[i][3]))       
                                acceso.sort(reverse=True)
                                for j in range(len(acceso)):
                                    if j<5:
                                        acceso1.append(acceso[j])
                                for j in range(len(acceso1)):
                                        for i in range(len(matriz_invitados)):
                                        
                                            if matriz_invitados[i][3]==str(acceso1[j]):
                                                dni.append(matriz_invitados[i][1])
                                
                                
                                # for i in range(len(acceso1)):
                                #     acceso1[i]=int(acceso1[i])
                                #     print(acceso1[i])
                                print(dni)
